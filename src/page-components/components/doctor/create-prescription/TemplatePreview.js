...
import host_copilot from "../../../../images/dental.png";
import dental_bottom from "../../../../images/dental-bottom.png";
import dental_left from "../../../../images/dental-left.png";
...
const TemplatePreview = () => {
  ...
  return (
    <div className="bg-[#111928] w-full h-full overflow-y-scroll flex flex-col items-center justify-center">
      <ToastContainer />
      <div
        ...
        <div ref={contentRef} className="text-[#1F2A37] relative text-sm">
          ...
          <div className="flex w-full">
            <div className="w-1/4 h-full">
              <img src={dental_left} alt="dental-left" />
            </div>
